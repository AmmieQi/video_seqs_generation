...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--display_freq', type=int, default=800, help='frequency of showing training results on screen')
        ...
        self.parser.add_argument('--niter_decay', type=int, default=141, help='# of iter to linearly decay learning rate to zero')
