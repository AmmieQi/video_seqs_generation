...
class BaseOptions():
    ...
    def initialize(self):
        ...
        #self.parser.add_argument('--trainroot', required=True, help='path to images (should have subfolders train, val, etc)')
        self.parser.add_argument('--testroot', required=True, help='path to images (should have subfolders train, val, etc)')
        self.parser.add_argument('--results_dir', type=str, default='./results/', help='saves results here.')
        self.parser.add_argument('--file_list', default=None, type=str, help='# file_list for loading data')
        #self.parser.add_argument('--train_file_list', default=None, type=str, help='# file_list for loading data')
        self.parser.add_argument('--test_file_list', default=None, type=str, help='# file_list for loading data')
	...
	self.parser.add_argument('--test_seq_len', type=int, default=10, help='sequence length of input')
        self.parser.add_argument('--test_seq_stride', type=int, default=10, help='sequence stride of input')
        self.parser.add_argument('--test_pre_len', type=int, default=20, help='sequence length of prediction')
        ...
        self.parser.add_argument('--which_model_netD', type=str, default='DCGAN', help='selects model to use for netD,DCGAN, basic nlyaers =3, or n_layers')
        self.parser.add_argument('--which_model_netG', type=str, default='Sequential', help='selects model to use for netG,Sequential or standalone')
        self.parser.add_argument('--which_model_E', type=str, default='resnet_6blocks', help='selects model to use for Encoder resnet_1,3,6')
        self.parser.add_argument('--n_layers_D', type=int, default=3, help='only used if which_model_netD==n_layers')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--name', type=str, default='experiment_name', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--dataset_mode', type=str, default='KTH', help='chooses how datasets are loaded. [KTH | UCF101 | others]')
        self.parser.add_argument('--model', type=str, default='seperate',
